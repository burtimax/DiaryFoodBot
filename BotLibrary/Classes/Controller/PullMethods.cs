...
namespace BotLibrary.Classes.Controller
{
    ...
    public class PullMethods
    {
        ...
        private Func<long, bool> _checkUserBeforeMessageProcess;
        ...
        public PullMethods([NotNull] Func<long, State> getCurrentUserState,
            [NotNull] Func<long,bool> checkUserBeforeMessageProcessing,
        ...
        public bool CheckUserBeforeMessageProcess(long chatId)
        {
            return this._checkUserBeforeMessageProcess(chatId);
        }
